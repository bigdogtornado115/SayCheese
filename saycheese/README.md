...
![Say Cheese](https://github.com/LinuxPhantom/saycheese/blob/main/56869077-e5714d80-69d1-11e9-8ce2-29a254021890.jpg)
...
```
git clone https://github.com/LinuxPhantom/SayCheese.git
cd saycheese
bash saycheese.sh
```
